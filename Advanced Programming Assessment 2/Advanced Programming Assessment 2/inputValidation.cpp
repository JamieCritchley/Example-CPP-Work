...
namespace inputValidation {
	...
	void printInstructions() {
		std::cout << "There are 2 main operations, creating and manipulating shapes, as well as auxilliary operations.\n"
			...
			"new top left X and Y coordinates.\nType 'scale' to scale an object up or down, followed by the factor of X and Y to scale the "
			"shape by.\nShapes can be scaled in a negative direction too.\nScale for equilateral and circular objects must have equal X and Y "
			"factors.\n"
